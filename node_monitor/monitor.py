...
def query_node_gpus(hostname: str, timeout: int = 10, show_processes: bool = False) -> NodeStatus:
    """
...
def query_all_nodes(hostnames: List[str], max_workers: int = 8, show_processes: bool = False) -> List[NodeStatus]:
    """
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        future_to_host = {
            executor.submit(query_node_gpus, host, 10, show_processes): host 
